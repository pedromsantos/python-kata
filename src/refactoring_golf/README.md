...
- For each hole:
  ...
  - Keep code running and tests passing at all times
...
2. Verify tests pass: `uv run pytest src/refactoring_golf`
3. Use hole-specific test runs: `uv run pytest src/refactoring_golf/hole1`, `uv run pytest src/refactoring_golf/hole2`, etc.
